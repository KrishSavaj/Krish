...
class AccessibilityManager extends Lifecycle_1.Disposable {
    constructor(_terminal, instantiationService, _coreBrowserService, _renderService) {
        ...
        this._topBoundaryFocusListener = e => this._handleBoundaryFocus(e, 0 /* BoundaryPosition.TOP */);
        this._bottomBoundaryFocusListener = e => this._handleBoundaryFocus(e, 1 /* BoundaryPosition.BOTTOM */);
    ...
    _handleBoundaryFocus(e, position) {
        ...
        const beforeBoundaryElement = this._rowElements[position === 0 /* BoundaryPosition.TOP */ ? 1 : this._rowElements.length - 2];
        // Don't scroll if the buffer top has reached the end in that direction
        const posInSet = boundaryElement.getAttribute('aria-posinset');
        const lastRowPos = position === 0 /* BoundaryPosition.TOP */ ? '1' : `${this._terminal.buffer.lines.length}`;
        ...
        if (position === 0 /* BoundaryPosition.TOP */) {
        ...
        this._rowElements[this._rowElements.length - 1].addEventListener('focus', this._bottomBoundaryFocusListener);
        // Scroll up
        this._terminal.scrollLines(position === 0 /* BoundaryPosition.TOP */ ? -1 : 1);
        // Focus new boundary before element
        this._rowElements[position === 0 /* BoundaryPosition.TOP */ ? 1 : this._rowElements.length - 2].focus();
