 ...
 */
class SelectionService extends Lifecycle_1.Disposable {
    constructor(_element, _screenElement, _linkifier, _bufferService, _coreService, _mouseService, _optionsService, _renderService, _coreBrowserService) {
        ...
        this._activeSelectionMode = 0 /* SelectionMode.NORMAL */;
    ...
    get selectionText() {
        ...
        const result = [];
        if (this._activeSelectionMode === 3 /* SelectionMode.COLUMN */) {
    ...
    _refresh() {
        ...
        this._onRedrawRequest.fire({
            ...
            columnSelectMode: this._activeSelectionMode === 3 /* SelectionMode.COLUMN */
        });
    }
    /**
    ...
    _handleSingleClick(event) {
        ...
        this._activeSelectionMode = this.shouldColumnSelect(event) ? 3 /* SelectionMode.COLUMN */ : 0 /* SelectionMode.NORMAL */;
    ...
    _handleDoubleClick(event) {
        if (this._selectWordAtCursor(event, true)) {
            this._activeSelectionMode = 1 /* SelectionMode.WORD */;
        }
    }
    /**
    ...
    _handleTripleClick(event) {
        const coords = this._getMouseBufferCoords(event);
        if (coords) {
            this._activeSelectionMode = 2 /* SelectionMode.LINE */;
    ...
    _handleMouseMove(event) {
        ...
        if (this._activeSelectionMode === 2 /* SelectionMode.LINE */) {
        ...
        else if (this._activeSelectionMode === 1 /* SelectionMode.WORD */) {
    ...
    _getWordAt(coords, allowWhitespaceOnlySelection, followWrappedLinesAbove = true, followWrappedLinesBelow = true) {
        ...
        // column coordinates.
        let start = startIndex // The index of the selection's start char in the line string
