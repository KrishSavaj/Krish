...
function evaluateKeyboardEvent(ev, applicationCursorMode, isMac, macOptionIsMeta) {
    const result = {
        type: Types_1.KeyboardResultType.SEND_KEY,
    ...
    switch (ev.keyCode) {
        ...
        case 8:
            // backspace
            result.key = ev.ctrlKey ? '\b' : EscapeSequences_1.C0.DEL; // ^H or ^?
            if (ev.altKey) {
        ...
        case 33:
            // page up
            if (ev.shiftKey) {
                result.type = Types_1.KeyboardResultType.PAGE_UP;
            }
            else if (ev.ctrlKey) {
        ...
        case 34:
            // page down
            if (ev.shiftKey) {
                result.type = Types_1.KeyboardResultType.PAGE_DOWN;
            }
            else if (ev.ctrlKey) {
        ...
        default:
            ...
            if (ev.ctrlKey && !ev.shiftKey && !ev.altKey && !ev.metaKey) {
                ...
                if (ev.keyCode === 65) { // cmd + a
                    result.type = Types_1.KeyboardResultType.SELECT_ALL;
                }
            }
