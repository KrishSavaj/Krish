...
class TextureAtlas {
    ...
    _createNewPage() {
        ...
        if (TextureAtlas.maxAtlasPages && this._pages.length >= Math.max(4, TextureAtlas.maxAtlasPages)) {
            ...
            const pagesBySize = this._pages.filter(e => {
                return e.canvas.width * 2 <= (TextureAtlas.maxTextureSize || 4096 /* Constants.FORCED_MAX_TEXTURE_SIZE */);
            }).sort((a, b) => {
    ...
    _drawToCache(codeOrChars, bg, fg, ext, restrictToCellHeight = false) {
            ...
            for (let i = 0; i < chWidth; i++) {
                ...
                switch (this._workAttributeData.extended.underlineStyle) {
                    ...
                    case Constants_2.UnderlineStyle.CURLY:
                        ...
                        break;
                    case Constants_2.UnderlineStyle.DOTTED:
                        ...
                        break;
                    case Constants_2.UnderlineStyle.DASHED:
                        const lineRatio = 0.6;
                        const gapRatio = 0.3;
                        ...
                        this._tmpCtx.lineTo(xChRight, yTop);
                        break;
                    case Constants_2.UnderlineStyle.SINGLE:
                    default:
                        this._tmpCtx.moveTo(xChLeft, yTop);
                        this._tmpCtx.lineTo(xChRight, yTop);
                        break;
        ...
        while (true) {
            ...
            // fixed height
            if (activeRow.y + rasterizedGlyph.size.y >= activePage.canvas.height || activeRow.height > rasterizedGlyph.size.y + 2 /* Constants.ROW_PIXEL_THRESHOLD */) {
