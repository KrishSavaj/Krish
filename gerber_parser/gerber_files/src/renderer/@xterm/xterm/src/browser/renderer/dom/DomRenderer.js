 ...
 */
class DomRenderer extends Lifecycle_1.Disposable {
    ...
    _injectCss(colors) {
        ...
        // Text styles
        styles +=
            `${this._terminalSelector} span:not(.${DomRendererRowFactory_1.RowCss.BOLD_CLASS}) {` +
                ` font-weight: ${this._optionsService.rawOptions.fontWeight};` +
                `}` +
                `${this._terminalSelector} span.${DomRendererRowFactory_1.RowCss.BOLD_CLASS} {` +
                ` font-weight: ${this._optionsService.rawOptions.fontWeightBold};` +
                `}` +
                `${this._terminalSelector} span.${DomRendererRowFactory_1.RowCss.ITALIC_CLASS} {` +
                ` font-style: italic;` +
                `}`;
        // Blink animation
        ...
        // Cursor
        styles +=
            `${this._terminalSelector} .${ROW_CONTAINER_CLASS}.${FOCUS_CLASS} .${DomRendererRowFactory_1.RowCss.CURSOR_CLASS}.${DomRendererRowFactory_1.RowCss.CURSOR_BLINK_CLASS}.${DomRendererRowFactory_1.RowCss.CURSOR_STYLE_UNDERLINE_CLASS} {` +
                ` animation: ${blinkAnimationUnderlineId} 1s step-end infinite;` +
                `}` +
                `${this._terminalSelector} .${ROW_CONTAINER_CLASS}.${FOCUS_CLASS} .${DomRendererRowFactory_1.RowCss.CURSOR_CLASS}.${DomRendererRowFactory_1.RowCss.CURSOR_BLINK_CLASS}.${DomRendererRowFactory_1.RowCss.CURSOR_STYLE_BAR_CLASS} {` +
                ` animation: ${blinkAnimationBarId} 1s step-end infinite;` +
                `}` +
                `${this._terminalSelector} .${ROW_CONTAINER_CLASS}.${FOCUS_CLASS} .${DomRendererRowFactory_1.RowCss.CURSOR_CLASS}.${DomRendererRowFactory_1.RowCss.CURSOR_BLINK_CLASS}.${DomRendererRowFactory_1.RowCss.CURSOR_STYLE_BLOCK_CLASS} {` +
                ...
                `${this._terminalSelector} .${ROW_CONTAINER_CLASS} .${DomRendererRowFactory_1.RowCss.CURSOR_CLASS}.${DomRendererRowFactory_1.RowCss.CURSOR_STYLE_BLOCK_CLASS} {` +
                ` background-color: ${colors.cursor.css};` +
                ` color: ${colors.cursorAccent.css};` +
                `}` +
                `${this._terminalSelector} .${ROW_CONTAINER_CLASS} .${DomRendererRowFactory_1.RowCss.CURSOR_CLASS}.${DomRendererRowFactory_1.RowCss.CURSOR_STYLE_BLOCK_CLASS}:not(.${DomRendererRowFactory_1.RowCss.CURSOR_BLINK_CLASS}) {` +
                ` background-color: ${colors.cursor.css} !important;` +
                ` color: ${colors.cursorAccent.css} !important;` +
                `}` +
                `${this._terminalSelector} .${ROW_CONTAINER_CLASS} .${DomRendererRowFactory_1.RowCss.CURSOR_CLASS}.${DomRendererRowFactory_1.RowCss.CURSOR_STYLE_OUTLINE_CLASS} {` +
                ` outline: 1px solid ${colors.cursor.css};` +
                ` outline-offset: -1px;` +
                `}` +
                `${this._terminalSelector} .${ROW_CONTAINER_CLASS} .${DomRendererRowFactory_1.RowCss.CURSOR_CLASS}.${DomRendererRowFactory_1.RowCss.CURSOR_STYLE_BAR_CLASS} {` +
                ` box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${colors.cursor.css} inset;` +
                `}` +
                `${this._terminalSelector} .${ROW_CONTAINER_CLASS} .${DomRendererRowFactory_1.RowCss.CURSOR_CLASS}.${DomRendererRowFactory_1.RowCss.CURSOR_STYLE_UNDERLINE_CLASS} {` +
        ...
        for (const [i, c] of colors.ansi.entries()) {
            styles +=
                `${this._terminalSelector} .${FG_CLASS_PREFIX}${i} { color: ${c.css}; }` +
                    `${this._terminalSelector} .${FG_CLASS_PREFIX}${i}.${DomRendererRowFactory_1.RowCss.DIM_CLASS} { color: ${Color_1.color.multiplyOpacity(c, 0.5).css}; }` +
        ...
        styles +=
            `${this._terminalSelector} .${FG_CLASS_PREFIX}${Constants_1.INVERTED_DEFAULT_COLOR} { color: ${Color_1.color.opaque(colors.background).css}; }` +
                `${this._terminalSelector} .${FG_CLASS_PREFIX}${Constants_1.INVERTED_DEFAULT_COLOR}.${DomRendererRowFactory_1.RowCss.DIM_CLASS} { color: ${Color_1.color.multiplyOpacity(Color_1.color.opaque(colors.background), 0.5).css}; }` +
