...
class ThemeService extends Lifecycle_1.Disposable {
    ...
    _restoreColor(slot) {
        ...
        switch (slot) {
            case Types_1.SpecialColorIndex.FOREGROUND:
                this._colors.foreground = this._restoreColors.foreground;
                break;
            case Types_1.SpecialColorIndex.BACKGROUND:
                this._colors.background = this._restoreColors.background;
                break;
            case Types_1.SpecialColorIndex.CURSOR:
