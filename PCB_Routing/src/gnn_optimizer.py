...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Run GNN optimizer on a PCB file")
    parser.add_argument("--pcb", type=str, required=False, help="Path to .kicad_pcb file")
    parser.add_argument("--use_ga", action="store_true", help="Use GA for optimization")
    parser.add_argument("--data_dir", type=str, default="data", help="Directory containing .kicad_pcb files")
    parser.add_argument("--out_json_dir", type=str, default="results/orderings_json", help="Where to save JSON results")
    args = parser.parse_args()

    if args.pcb:
        board_name = os.path.basename(args.pcb)
        data_dir = os.path.dirname(args.pcb) or "../data"
        ...
        predict_and_optimize(use_ga=args.use_ga)
