...
namespace Odb::Lib::FileModel::Design
{
	StepHdrFile::~StepHdrFile()
	{
     ...
     std::string StepHdrFile::GetUnits() const { return m_units; }
    float StepHdrFile::GetXDatum() const { return xDatum; }
    float StepHdrFile::GetYDatum() const { return yDatum; }
    unsigned StepHdrFile::GetId() const { return id; }
    float StepHdrFile::GetXOrigin() const { return xOrigin; }
    float StepHdrFile::GetYOrigin() const { return yOrigin; }
    float StepHdrFile::GetTopActive() const { return topActive; }
    float StepHdrFile::GetBottomActive() const { return bottomActive; }
    float StepHdrFile::GetRightActive() const { return rightActive; }
    float StepHdrFile::GetLeftActive() const { return leftActive; }
    std::string StepHdrFile::GetAffectingBom() const { return affectingBom; }
    bool StepHdrFile::GetAffectingBomChanged() const { return affectingBomChanged; }
    const std::map<std::string, std::string>& StepHdrFile::GetOnlineValues() const { return m_onlineValues; }
    // Notice the fully qualified nested type in the return type:
    const std::vector<std::shared_ptr<StepHdrFile::StepRepeatRecord>>& StepHdrFile::GetStepRepeatRecords() const { return m_stepRepeatRecords; }
